...
type Profile struct {
	...
	AccountType AccountType `protobuf:"varint,2,opt,name=account_type,json=accountType,proto3,enum=aic_api.AccountType" json:"account_type,omitempty" form:"account_type" query:"account_type"`
	// User data
	Email          string  `protobuf:"bytes,10,opt,name=email,proto3" json:"email,omitempty" form:"email" query:"email"`
	DisplayPicture string  `protobuf:"bytes,11,opt,name=display_picture,json=displayPicture,proto3" json:"display_picture,omitempty" form:"display_picture" query:"display_picture"`
	DisplayName    string  `protobuf:"bytes,12,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty" form:"display_name" query:"display_name"`
	School         *School `protobuf:"bytes,13,opt,name=school,proto3" json:"school,omitempty" form:"school" query:"school"`
	// Affliations
	Affliations []*Affliation `protobuf:"bytes,20,rep,name=affliations,proto3" json:"affliations" form:"affliations" query:"affliations"`
	IsBanned    bool          `protobuf:"varint,200,opt,name=is_banned,json=isBanned,proto3" json:"is_banned,omitempty" form:"is_banned" query:"is_banned"`
}
...
type Affliation struct {
	...
	// Metadata
	AffliationType AffliationType `protobuf:"varint,1,opt,name=affliation_type,json=affliationType,proto3,enum=aic_api.AffliationType" json:"affliation_type,omitempty" form:"affliation_type" query:"affliation_type"`
	// School
	School *School `protobuf:"bytes,20,opt,name=school,proto3" json:"school,omitempty" form:"school" query:"school"`
	// Tuition Centre
	TuitionCentre *TuitionCentre `protobuf:"bytes,30,opt,name=tuition_centre,json=tuitionCentre,proto3" json:"tuition_centre,omitempty" form:"tuition_centre" query:"tuition_centre"`
}
...
type Question struct {
	...
	// Metadata
	Uid     string  `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty" form:"uid" query:"uid"`
	Tier    Tier    `protobuf:"varint,2,opt,name=tier,proto3,enum=aic_api.Tier" json:"tier,omitempty" form:"tier" query:"tier"`
	Subject Subject `protobuf:"varint,3,opt,name=subject,proto3,enum=aic_api.Subject" json:"subject,omitempty" form:"subject" query:"subject"`
	TopicId string  `protobuf:"bytes,4,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty" form:"topic_id" query:"topic_id"`
	// Source
	School     *School  `protobuf:"bytes,10,opt,name=school,proto3" json:"school,omitempty" form:"school" query:"school"`
	PaperYear  string   `protobuf:"bytes,11,opt,name=paper_year,json=paperYear,proto3" json:"paper_year,omitempty" form:"paper_year" query:"paper_year"`
	PaperName  string   `protobuf:"bytes,12,opt,name=paper_name,json=paperName,proto3" json:"paper_name,omitempty" form:"paper_name" query:"paper_name"`
	UploadedBy *Profile `protobuf:"bytes,13,opt,name=uploaded_by,json=uploadedBy,proto3" json:"uploaded_by,omitempty" form:"uploaded_by" query:"uploaded_by"`
	UploadedAt int64    `protobuf:"varint,14,opt,name=uploaded_at,json=uploadedAt,proto3" json:"uploaded_at,omitempty" form:"uploaded_at" query:"uploaded_at"`
	// Question
	QuestionString string `protobuf:"bytes,20,opt,name=question_string,json=questionString,proto3" json:"question_string,omitempty" form:"question_string" query:"question_string"`
	// Options
	OptionA string `protobuf:"bytes,30,opt,name=option_a,json=optionA,proto3" json:"option_a,omitempty" form:"option_a" query:"option_a"`
	OptionB string `protobuf:"bytes,31,opt,name=option_b,json=optionB,proto3" json:"option_b,omitempty" form:"option_b" query:"option_b"`
	OptionC string `protobuf:"bytes,32,opt,name=option_c,json=optionC,proto3" json:"option_c,omitempty" form:"option_c" query:"option_c"`
	OptionD string `protobuf:"bytes,33,opt,name=option_d,json=optionD,proto3" json:"option_d,omitempty" form:"option_d" query:"option_d"`
	// Answer
	CorrectAnswerHash string `protobuf:"bytes,40,opt,name=correct_answer_hash,json=correctAnswerHash,proto3" json:"correct_answer_hash,omitempty" form:"correct_answer_hash" query:"correct_answer_hash"`
	// Analysis
	QuestionAnalysis *QuestionAnalysis `protobuf:"bytes,50,opt,name=question_analysis,json=questionAnalysis,proto3" json:"question_analysis,omitempty" form:"question_analysis" query:"question_analysis"`
	// User specific data
	NumberOfAttempts uint64 `protobuf:"varint,60,opt,name=number_of_attempts,json=numberOfAttempts,proto3" json:"number_of_attempts,omitempty" form:"number_of_attempts" query:"number_of_attempts"`
}
...
type QuestionAnalysis struct {
	...
	// Metadata
	Year string `protobuf:"bytes,1,opt,name=year,proto3" json:"year,omitempty" form:"year" query:"year"`
	// Attempts
	TotalAttempts     uint64 `protobuf:"varint,10,opt,name=total_attempts,json=totalAttempts,proto3" json:"total_attempts,omitempty" form:"total_attempts" query:"total_attempts"`
	CorrectAttempts   uint64 `protobuf:"varint,11,opt,name=correct_attempts,json=correctAttempts,proto3" json:"correct_attempts,omitempty" form:"correct_attempts" query:"correct_attempts"`
	IncorrectAttempts uint64 `protobuf:"varint,12,opt,name=incorrect_attempts,json=incorrectAttempts,proto3" json:"incorrect_attempts,omitempty" form:"incorrect_attempts" query:"incorrect_attempts"`
	// Analysis
	CorrectAnswerPercentage uint32 `protobuf:"varint,20,opt,name=correct_answer_percentage,json=correctAnswerPercentage,proto3" json:"correct_answer_percentage,omitempty" form:"correct_answer_percentage" query:"correct_answer_percentage"`
	AverageTimeTaken        string `protobuf:"bytes,21,opt,name=average_time_taken,json=averageTimeTaken,proto3" json:"average_time_taken,omitempty" form:"average_time_taken" query:"average_time_taken"`
	// Statistics
	SdTimeCorrectAttempts   float32 `protobuf:"fixed32,30,opt,name=sd_time_correct_attempts,json=sdTimeCorrectAttempts,proto3" json:"sd_time_correct_attempts,omitempty" form:"sd_time_correct_attempts" query:"sd_time_correct_attempts"`
	MeanTimeCorrectAttempts float32 `protobuf:"fixed32,31,opt,name=mean_time_correct_attempts,json=meanTimeCorrectAttempts,proto3" json:"mean_time_correct_attempts,omitempty" form:"mean_time_correct_attempts" query:"mean_time_correct_attempts"`
	// Likes
	NumberOfLikes uint64 `protobuf:"varint,40,opt,name=number_of_likes,json=numberOfLikes,proto3" json:"number_of_likes,omitempty" form:"number_of_likes" query:"number_of_likes"`
}
...
type AnswerAnalysis struct {
	...
	// Metadata
	Uid       string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty" form:"uid" query:"uid"`
	Option    Option `protobuf:"varint,2,opt,name=option,proto3,enum=aic_api.Option" json:"option,omitempty" form:"option" query:"option"`
	IsCorrect bool   `protobuf:"varint,3,opt,name=is_correct,json=isCorrect,proto3" json:"is_correct,omitempty" form:"is_correct" query:"is_correct"`
	// Analysis
	// TODO
	AnswerAnalysisBreakdown *AnswerAnalysisBreakdown `protobuf:"bytes,10,opt,name=answer_analysis_breakdown,json=answerAnalysisBreakdown,proto3" json:"answer_analysis_breakdown,omitempty" form:"answer_analysis_breakdown" query:"answer_analysis_breakdown"`
}
...
type Attempt struct {
	...
	// Metadata
	Uid         string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty" form:"uid" query:"uid"`
	QuestionUid string `protobuf:"bytes,2,opt,name=question_uid,json=questionUid,proto3" json:"question_uid,omitempty" form:"question_uid" query:"question_uid"`
	UserUid     string `protobuf:"bytes,3,opt,name=user_uid,json=userUid,proto3" json:"user_uid,omitempty" form:"user_uid" query:"user_uid"`
	// Attempt
	Answer    Option `protobuf:"varint,10,opt,name=answer,proto3,enum=aic_api.Option" json:"answer,omitempty" form:"answer" query:"answer"`
	TimeTaken string `protobuf:"bytes,11,opt,name=time_taken,json=timeTaken,proto3" json:"time_taken,omitempty" form:"time_taken" query:"time_taken"`
}
...
type Solution struct {
	...
	Uid         string   `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty" form:"uid" query:"uid"`
	QuestionUid string   `protobuf:"bytes,2,opt,name=question_uid,json=questionUid,proto3" json:"question_uid,omitempty" form:"question_uid" query:"question_uid"`
	SubmittedBy *Profile `protobuf:"bytes,3,opt,name=submitted_by,json=submittedBy,proto3" json:"submitted_by,omitempty" form:"submitted_by" query:"submitted_by"`
	// Solution content
	Solution       string   `protobuf:"bytes,10,opt,name=solution,proto3" json:"solution,omitempty" form:"solution" query:"solution"`
	SolutionImages []string `protobuf:"bytes,11,rep,name=solution_images,json=solutionImages,proto3" json:"solution_images" form:"solution_images" query:"solution_images"`
	// Other data
	NumberOfLikes uint64 `protobuf:"varint,20,opt,name=number_of_likes,json=numberOfLikes,proto3" json:"number_of_likes,omitempty" form:"number_of_likes" query:"number_of_likes"`
}
...
type Discussion struct {
	...
	SubmittedBy *Profile `protobuf:"bytes,3,opt,name=submitted_by,json=submittedBy,proto3" json:"submitted_by,omitempty" form:"submitted_by" query:"submitted_by"`
	// Discussion content
	Discussion       string   `protobuf:"bytes,10,opt,name=discussion,proto3" json:"discussion,omitempty" form:"discussion" query:"discussion"`
	DiscussionImages []string `protobuf:"bytes,11,rep,name=discussion_images,json=discussionImages,proto3" json:"discussion_images" form:"discussion_images" query:"discussion_images"`
	// Other data
	NumberOfLikes    uint64 `protobuf:"varint,20,opt,name=number_of_likes,json=numberOfLikes,proto3" json:"number_of_likes,omitempty" form:"number_of_likes" query:"number_of_likes"`
	NumberOfComments uint64 `protobuf:"varint,30,opt,name=number_of_comments,json=numberOfComments,proto3" json:"number_of_comments,omitempty" form:"number_of_comments" query:"number_of_comments"`
}
...
type School struct {
	...
	// Metadata
	Uid     string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty" form:"uid" query:"uid"`
	LogoUrl string `protobuf:"bytes,2,opt,name=logo_url,json=logoUrl,proto3" json:"logo_url,omitempty" form:"logo_url" query:"logo_url"`
	// School data
	Name string `protobuf:"bytes,10,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	Tier Tier   `protobuf:"varint,11,opt,name=tier,proto3,enum=aic_api.Tier" json:"tier,omitempty" form:"tier" query:"tier"`
}
...
type TuitionCentre struct {
	...
	// Tution Centre data
	Name          string `protobuf:"bytes,10,opt,name=name,proto3" json:"name,omitempty" form:"name" query:"name"`
	Address       string `protobuf:"bytes,11,opt,name=address,proto3" json:"address,omitempty" form:"address" query:"address"`
	ContactNumber string `protobuf:"bytes,12,opt,name=contact_number,json=contactNumber,proto3" json:"contact_number,omitempty" form:"contact_number" query:"contact_number"`
	Email         string `protobuf:"bytes,13,opt,name=email,proto3" json:"email,omitempty" form:"email" query:"email"`
	Tier          []Tier `protobuf:"varint,14,rep,packed,name=tier,proto3,enum=aic_api.Tier" json:"tier" form:"tier" query:"tier"`
}
...
type Pagination struct {
	...
	TotalPages int32 `protobuf:"varint,3,opt,name=total_pages,json=totalPages,proto3" json:"total_pages,omitempty" form:"total_pages" query:"total_pages"`
}
...
var file_aic_data_aic_api_models_proto_rawDesc = []byte{
	...
	0x0a, 0x42, 0x52, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x61, 0x69, 0x63, 0x2f, 0x61, 0x69, 0x63, 0x5f, 0x61, 0x70, 0x69, 0x2f, 0x62, 0x69, 0x7a, 0x2f,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
